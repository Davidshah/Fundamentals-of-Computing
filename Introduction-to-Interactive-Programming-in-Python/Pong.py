...
def draw(c):
    ...
    gutterL = ball_pos[0] <= PAD_WIDTH + BALL_RADIUS
    gutterR = ball_pos[0] >= WIDTH - (PAD_WIDTH + BALL_RADIUS)
    if gutterL:
    ...
    c.draw_text(str(score1), (((WIDTH / 2)-100), 50), 36, "White")
    c.draw_text(str(score2), (((WIDTH / 2)+83), 50), 36, "White")
